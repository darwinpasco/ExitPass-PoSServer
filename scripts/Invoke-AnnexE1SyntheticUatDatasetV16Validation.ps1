...
function Get-CasePackageRecord {
    ...
    $root = @(
        [pscustomobject][ordered]@{ n='specificationId'; t='string'; v='ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_v1.6' },
...
$populationPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Canonical_Source_Row_Population_v1.6.md"
$manifestPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_Manifest_v1.6.md"
$hashContractPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Canonical_Source_Row_and_Hash_Contract_v1.6.md"
$mappingPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Scenario_to_Dataset_Mapping_v1.6.md"
$expectedValuesPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Expected_Value_Matrix_v1.6.md"
$externalDecisionsPath = Join-Path $annexRoot "ExitPass_POS_Server_Annex_E1_External_Decision_to_Scenario_Reconciliation_Matrix_v1.6.md"
if ([string]::IsNullOrWhiteSpace($DatasetPath)) {
    $DatasetPath = Join-Path $annexRoot "dataset\v1.6\annex-e1-synthetic-uat-dataset-v1.6.jsonl"
}
...
$packageRoot = Get-Ae1hPreimage 'annex-e1-specification-package-root' 'sha256:v1.6' 'v1.6' @(
...
$metadata = [pscustomobject][ordered]@{
    ...
    schemaVersion = 'annex-e1-synthetic-uat-dataset:v1.6'
