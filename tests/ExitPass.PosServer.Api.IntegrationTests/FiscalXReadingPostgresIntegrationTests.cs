...
public sealed class FiscalXReadingPostgresIntegrationTests
{
    ...
    private static async Task ProveConcurrentUncommittedDocumentIsExcludedAsync(string connectionString, HttpClient client)
    {
        ...
        await using (var command = new NpgsqlCommand("INSERT INTO pos.fiscal_documents(fiscal_document_id,site_pos_server_id,fiscal_identity_id,fiscal_document_type_code_id,fiscal_document_status_code_id,business_day_date,currency_code,fiscal_reporting_period_id,payment_finality_ref,completion_basis,completion_authority_ref,created_at,updated_at) VALUES('73000000-0000-4000-8000-000000000399',@site,@identity,'73000000-0000-4000-8000-000000000201','73000000-0000-4000-8000-000000000202','2026-08-03','PHP','73000000-0000-4000-8000-000000000010','payment-finality-x-399','PAYMENT_FINALITY','payment-finality-x-399','2026-08-03T03:00:00Z','2026-08-03T03:00:00Z')", connection, transaction))
    ...
    private static async Task InsertUnsupportedTenderDocumentAsync(string connectionString)
    {
        ...
        INSERT INTO pos.fiscal_documents(fiscal_document_id,site_pos_server_id,fiscal_identity_id,fiscal_document_type_code_id,fiscal_document_status_code_id,fiscal_sequence_policy_id,fiscal_sequence_value,fiscal_document_number,fiscal_series,fiscal_number_assigned_at,business_day_date,currency_code,fiscal_reporting_period_id,payment_finality_ref,completion_basis,completion_authority_ref,created_at,updated_at) VALUES('73000000-0000-4000-8000-000000000303','73000000-0000-4000-8000-000000000001','73000000-0000-4000-8000-000000000002','73000000-0000-4000-8000-000000000201','73000000-0000-4000-8000-000000000202','73000000-0000-4000-8000-000000000003',3,'SI-00000003','SI','2026-08-03T03:00:00Z','2026-08-03','PHP','73000000-0000-4000-8000-000000000010','payment-finality-x-003','PAYMENT_FINALITY','payment-finality-x-003','2026-08-03T03:00:00Z','2026-08-03T03:00:00Z');
