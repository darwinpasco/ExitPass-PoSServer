# ExitPass POS Server Annex E-1 Synthetic UAT Source Population and Reconciliation Matrix v1.6

## 1. Normative expansion

A row is the unique product of scenario, registered object token and ordinal, the v1.6 canonical row contract, its profile, and deterministic chronology. The canonical population document supplies every field value or closed expression. Missing bindings fail validation; database defaults and runtime-generated values are not substituted.
...
| R08 | all copied IDs and v1.6 hashes exact | exact | exact |
