...
3. [Synthetic UAT Expected Value Matrix v1.1](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Expected_Value_Matrix_v1.1.md)
4. [Synthetic UAT Source Population and Reconciliation Matrix v1.1](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Source_Population_and_Reconciliation_Matrix_v1.1.md)
5. [External Decision-to-Scenario Reconciliation Matrix v1.1](ExitPass_POS_Server_Annex_E1_External_Decision_to_Scenario_Reconciliation_Matrix_v1.1.md)
6. [Synthetic UAT Dataset Specification Correction Resolution Matrix v1.1](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_Correction_Resolution_Matrix_v1.1.md)
7. [Synthetic UAT Dataset Specification Manifest v1.1](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_Manifest_v1.1.md)
8. [Synthetic UAT Dataset Specification v1.1 Authorization Review](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_v1.1_Authorization_Review_v1.0.md)
9. [Synthetic UAT Dataset Specification Authorization Review](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_Authorization_Review_v1.0.md)
10. [Historical Synthetic UAT Dataset Specification v1.0](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_v1.0.md)
11. [Historical Synthetic UAT Scenario-to-Dataset Mapping v1.0](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Scenario_to_Dataset_Mapping_v1.0.md)
12. [Historical Synthetic UAT Expected Value Matrix v1.0](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Expected_Value_Matrix_v1.0.md)
13. [Historical Synthetic UAT Source Population and Reconciliation Matrix v1.0](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Source_Population_and_Reconciliation_Matrix_v1.0.md)
14. [Historical External Decision-to-Scenario Reconciliation Matrix v1.0](ExitPass_POS_Server_Annex_E1_External_Decision_to_Scenario_Reconciliation_Matrix_v1.0.md)
15. [Historical Synthetic UAT Dataset Specification Manifest v1.0](ExitPass_POS_Server_Annex_E1_Synthetic_UAT_Dataset_Specification_Manifest_v1.0.md)
16. [Controlled UAT Authorization Review](ExitPass_POS_Server_Annex_E1_Controlled_UAT_Authorization_Review_v1.0.md)
17. [Z-012D Controlled UAT Preparation Plan](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Preparation_Plan_v1.0.md)
18. [Z-012D Synthetic Scenario Catalogue](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Synthetic_Scenario_Catalogue_v1.0.md)
19. [Z-012D Evidence Manifest Template](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Evidence_Manifest_Template_v1.0.md)
20. [Z-012D Environment Readiness Checklist](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Environment_Readiness_Checklist_v1.0.md)
21. [Z-012D Authority and Responsibility Matrix](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Authority_and_Responsibility_Matrix_v1.0.md)
22. [Z-012D Rollback and Cleanup Checklist](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_Rollback_and_Cleanup_Checklist_v1.0.md)
23. [Z-012D External Confirmation Tracker](ExitPass_POS_Server_Z012D_Annex_E1_Controlled_UAT_External_Confirmation_Tracker_v1.0.md)
24. [Z-012C Controlled UAT Gate Revalidation](ExitPass_POS_Server_Z012C_Annex_E1_Controlled_UAT_Gate_Revalidation_v1.0.md)
25. [External Confirmation Closure Package](ExitPass_POS_Server_Annex_E1_External_Confirmation_Closure_Package_v1.0.md)
26. [Z-012B Deterministic Runtime Implementation](ExitPass_POS_Server_Z012B_Annex_E1_Deterministic_Runtime_Implementation_v1.0.md)
27. [Z-012A2 Accounting Approval and Runtime Authorization Revalidation](ExitPass_POS_Server_Z012A2_Annex_E1_Accounting_Approval_and_Runtime_Authorization_Revalidation_v1.0.md)
28. [Approved Accounting Calculation Profile](ExitPass_POS_Server_Annex_E1_Accounting_Calculation_Profile_Proposal_v1.0.md)
29. [Accounting Approval Form and Record](ExitPass_POS_Server_Annex_E1_Accounting_Calculation_Profile_Approval_Form_v1.0.md)
30. [Z-012A Runtime Authorization Revalidation](ExitPass_POS_Server_Z012A_Annex_E1_Runtime_Authorization_Revalidation_v1.0.md)
31. [Source and Applicability Assessment](ExitPass_POS_Server_BIR_Annex_E_Source_and_Applicability_Assessment_v1.0.md)
32. [Decision Resolution Summary](ExitPass_POS_Server_BIR_Annex_E_Decision_Resolution_Summary_v1.0.md)
33. [Open Decisions and Assumptions Register](ExitPass_POS_Server_BIR_Annex_E_Open_Decisions_and_Assumptions_Register_v1.0.md)
34. [User Approval Record](ExitPass_POS_Server_BIR_Annex_E_User_Approval_Record_v1.0.md)
35. [External Confirmation Register](ExitPass_POS_Server_BIR_Annex_E_External_Confirmation_Register_v1.0.md)
36. [Field Dictionary](ExitPass_POS_Server_BIR_Annex_E_Field_Dictionary_v1.0.md)
37. [Source-to-Output Mapping Matrix](ExitPass_POS_Server_BIR_Annex_E_Source_to_Output_Mapping_Matrix_v1.0.md)
38. [Calculation and Reconciliation Rules](ExitPass_POS_Server_BIR_Annex_E_Calculation_and_Reconciliation_Rules_v1.0.md)
39. [File Layout and Export Specification](ExitPass_POS_Server_BIR_Annex_E_File_Layout_and_Export_Specification_v1.0.md)
40. [Sample Output and Traceability](ExitPass_POS_Server_BIR_Annex_E_Sample_Output_and_Traceability_v1.0.md)
41. [Validation and Acceptance Scenarios](ExitPass_POS_Server_BIR_Annex_E_Validation_and_Acceptance_Scenarios_v1.0.md)
42. [Z-009 Runtime Implementation Handoff](ExitPass_POS_Server_Z009_Annex_E_Runtime_Implementation_Handoff_v1.0.md)
43. [Runtime Authorization Checklist](ExitPass_POS_Server_Z009_Annex_E_Runtime_Authorization_Checklist_v1.0.md)
...
**Synthetic dataset specification v1.1 correction status: `READY_FOR_V1_1_SPECIFICATION_AUTHORIZATION_REVIEW`.** This is a document status, not an implementation authorization token. The v1.1 package addresses all eight review findings: deterministic identity and ordinal registry; semantic-hash inventory and nested ordering; supportable SP-A statutory sources; canonical row completeness; in-period Accounting-fact effective times; a documentation-only deterministic-clock contract; removal of no-activity leakage from cases 004 and 005; and a complete 148-row Electronic Journal contract. The v1.0 package remains historical and immutable. v1.1 supersedes it only for future authorization consideration and does not change the v1.0 review result.

**Synthetic dataset specification v1.1 authorization review: `BLOCKED_ANNEX_E1_SYNTHETIC_DATASET_IMPLEMENTATION`.** The independent review verified package hashes, the 2,364 collision-free identities, scenario partition, C02 timestamp specification, clock-boundary separation, no-activity correction, 22-row structural coverage, and the published Annex semantic-hash vectors. It did not accept v1.1 for implementation because the package hash and source rows remain under-specified, SP-A line arithmetic cannot pass the current fiscal-document validator, the C02 prerequisite ordering conflicts with offline implementation authority, and the 148 Electronic Journal hashes cannot be reproduced from the contradictory transition-reference contract and missing transition versions.
...
**Synthetic dataset specification v1.3 package status: `READY_FOR_V1_3_SPECIFICATION_AUTHORIZATION_REVIEW`.** Version 1.3 prospectively closes the three v1.2 review blockers through an explicit binary length-prefixed hash grammar and non-empty vectors, a current-runtime-valid tax-inclusive SP-A statutory original amount of 11200, and a dedicated deterministic population contract for all 29 row families. It preserves the 2,364 identities, 19/6 scenario partition, 22 Annex rows, 155 in-period Accounting facts, 148-event Electronic Journal ledger, and all governed counts. This is package-author readiness, not implementation authority.
...
**Synthetic dataset specification v1.5 package status: `READY_FOR_V1_5_SPECIFICATION_AUTHORIZATION_REVIEW`.** Version 1.5 corrects only the merged v1.4 review findings IR14-01, IR14-02, and E14-01. Its single definitive authorization-critical registry publishes and independently reconstructs all 1,690 semantic rows: 840 preserved v1.4 rows, 148 incorporated F22 Electronic Journal rows, and 702 newly corrected rows in F01, F07-F10, F12-F15, and F23. The redundant and unreproducible v1.4 Appendix A binding digests, lengths, and commitment are removed. M01 package-root framing, M02 runtime parking identity/finality, and M04 acyclic hash graph remain preserved.

**Current canonical token: `BLOCKED_ANNEX_E1_SYNTHETIC_DATASET_IMPLEMENTATION`.** Version 1.5 author-side readiness does not authorize dataset or validator implementation, excluded scenarios, runtime/application/API/database/migration/configuration/dependency/CI changes, provisioning, role assignment, loading, Controlled UAT, evidence acceptance, workbook generation, delivery, BIR submission, Production, Annex E-2 through E-5, ARTS POSLog, signing, encryption, or destructive retention or purge.

All ten external confirmations remain `UNRESOLVED`: AE-DR-002, AE-DR-004, AE-DR-010, AE-DR-011A, AE-DR-012, AE-DR-016, AE-DR-016B, AE-DR-019, AE-DR-020A, and AE-DR-024. None supplies a byte required by the bounded 19-scenario offline dataset.

**Synthetic dataset specification v1.5 authorization review: `AUTHORIZED_ANNEX_E1_SYNTHETIC_DATASET_IMPLEMENTATION`.** The independent review reproduced all eight exact member hashes and lengths, the 1,897-byte package root, all 1,690 semantic rows across 29 families, the 148 F22 records and 148 F23 transitions, all 30 current-runtime statutory finality cases, all 2,364 deterministic identities, all 155 C02 facts, SP-A and R01-R12 arithmetic, governed counts, and the acyclic M04 graph. No legitimate blocker remains.
...
## Annex E-1 synthetic dataset v1.7 correction and isolated execution

**Corrected v1.7 package and dataset: `READY_FOR_REVIEW`.** Version 1.7 changes only `F16|013|0008.correction_reason` from unsupported `SYNTHETIC_CORRECTION` to the existing canonical `source_correction` code. Its UUID, amount 600, superseded fact, timestamps, and every unrelated semantic tuple remain unchanged. The correction fact, audit descendant, v1.7 case-package envelopes, eight member commitments, package root, and JSONL dataset are deterministically regenerated. Versions 1.0 through 1.6 remain immutable.

**Isolated execution harness: test-only.** Run `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\Invoke-AnnexE1V17IsolatedExecution.ps1` from the repository root. The command validates the committed v1.7 JSONL, creates unique loopback-only disposable PostgreSQL resources, rebuilds the canonical POS schema, resolves `source_correction` from the existing controlled-code set, stages and reads back all 4,074 records, executes the 19 included cases through existing runtime services, compares two clean normalized reports, exercises negative and cleanup paths, and removes its resources in `finally` handling.

The harness does not add a controlled code, alias, translation, migration, runtime workaround, endpoint, dependency, or CI integration. It does not authorize shared database loading, Controlled UAT, workbook generation, evidence acceptance, delivery, BIR submission, or Production use.

## Annex E-1 v1.7 internal workbook presentation review

[Internal Workbook Presentation and Controlled UAT Readiness Review v1.0](ExitPass_POS_Server_Annex_E1_v1.7_Internal_Workbook_Presentation_and_Controlled_UAT_Readiness_Review_v1.0.md) records `BLOCKED_WORKBOOK_RENDERING`. The deterministic generator, manifest commitments, semantic validations, isolated execution, and runtime tests pass, but Microsoft Excel rejects all 19 generated `.xlsx` packages before rendering. The printable `E-1` sheet also omits the required `SYNTHETIC / INTERNAL TEST ONLY / NOT FOR BIR SUBMISSION` warning that is present on the diagnostic sheets.

Controlled UAT authorization must wait for a bounded workbook-generation correction and a repeated independent rendering review. This finding does not require official BIR submission presentation, filename, delivery, signing, or acceptance rules to be resolved before technical Controlled UAT; those matters remain a separate external-governance workstream. No Controlled UAT, evidence acceptance, external delivery, BIR submission, or Production use is authorized.

## Annex E-1 v1.7 workbook interoperability correction

**Correction status: `READY_FOR_REVIEW`.** The test-only workbook generator removes the incomplete optional `<fileVersion appName="xl"/>` element that reproduced Microsoft Excel error `0x800A03EC`, validates generated packages with `DocumentFormat.OpenXml` 3.5.1 plus a focused Excel interoperability rule, and places the exact internal-test warning visibly inside every printable `E-1` sheet at `A11:AF11`. All 19 corrected workbooks open normally in Microsoft Excel 16.0 build 20228 without requesting repair or extraction. Their generated artifact and manifest hashes changed deterministically; all v1.7 package, dataset, semantic, identity, and normalized semantic commitments remain unchanged.

This author-side correction is not Controlled UAT authorization. The exact next bounded activity is to repeat the independent Annex E-1 v1.7 workbook rendering, visual presentation, print, and Controlled UAT readiness review. Official BIR presentation, delivery, signing, acceptance, submission, and Production use remain outside this correction.

## Annex E-1 v1.7 workbook presentation revalidation

[Internal Workbook Presentation and Controlled UAT Readiness Revalidation v1.0](ExitPass_POS_Server_Annex_E1_v1.7_Internal_Workbook_Presentation_and_Controlled_UAT_Readiness_Revalidation_v1.0.md) records `READY_FOR_CONTROLLED_UAT_AUTHORIZATION`. Microsoft Excel opens all 19 corrected workbooks normally, every printable `E-1` sheet exports as one readable landscape PDF page, all 22 Annex rows pass visual review, and the exact internal-test warning remains visible in each worksheet and PDF. Corrected workbook and manifest hashes, v1.7 semantic commitments, isolated execution, Open XML validation, 15 negative tests, 209 runtime tests, and two-run determinism all pass.

This decision does not begin Controlled UAT or approve an official BIR submission workbook. The next bounded task is to prepare Annex E-1 Controlled UAT execution authorization. External BIR presentation, filename, delivery, signing, acceptance, submission, and Production use remain separately governed and unauthorized.

## Annex E-1 v1.7 Controlled UAT execution authorization

[Controlled UAT Execution Authorization v1.0](ExitPass_POS_Server_Annex_E1_v1.7_Controlled_UAT_Execution_Authorization_v1.0.md) records `AUTHORIZED_FOR_ANNEX_E1_V1_7_CONTROLLED_UAT_EXECUTION`. It authorizes a separately initiated, synthetic-only execution of the exact frozen 19-case v1.7 dataset in invocation-owned loopback PostgreSQL resources, followed by deterministic workbook generation, Excel/PDF/visual review, governed evidence capture, and independently verified cleanup. Every baseline, environment, role, acceptance, stop, evidence, cleanup, and retention condition fails closed.

The authorization document does not execute Controlled UAT. The exact next bounded task is to execute Annex E-1 v1.7 Controlled UAT under that approved authorization and produce the governed evidence package. The workbooks and derived artifacts remain synthetic internal evidence and are not approved for external delivery, official BIR submission, Production, Annex E-2 through E-5, or ARTS POSLog.
